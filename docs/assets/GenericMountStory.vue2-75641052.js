...
const Comp9 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-acc88191.js").then((n) => n.at), true ? [] : void 0, import.meta.url));
let files = [
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-76245b95.js"), true ? ["./HomeView.vue-76245b95.js","./vendor-acc88191.js"] : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-2e6a86e9.js"), true ? ["./StoryView.vue-2e6a86e9.js","./vendor-acc88191.js","./MobileOverlay.vue2-5a466205.js","./BaseEmpty.vue-baa2187e.js","./state-a9effce5.js"] : void 0, import.meta.url)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-acc88191.js").then((n) => n.au), true ? [] : void 0, import.meta.url),
  "vue3": () => __vitePreload(() => import("./vendor-acc88191.js").then((n) => n.av), true ? [] : void 0, import.meta.url)
};
const __default__ = {
  inheritAttrs: false
};
