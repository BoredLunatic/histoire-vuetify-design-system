...
const Comp6 = { "title": "Option Defaults", "icon": "carbon:floorplan", "group": "getting-started", "docsOnly": true, "variants": [] };
...
const Comp10 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-ac1bc468.js").then((n) => n.at), true ? [] : void 0, import.meta.url));
let files = [
  ...
  { "id": "src-docs-getting-started-optionsdefaults-story-js", "path": ["Option Defaults"], "filePath": "src/docs/getting-started/OptionsDefaults.story.js", "story": { "id": "src-docs-getting-started-optionsdefaults-story-js", "title": "Option Defaults", "group": "getting-started", "layout": { "type": "single", "iframe": true }, "icon": "carbon:floorplan", "docsOnly": true, "variants": [] }, "supportPluginId": "vanilla", "docsFilePath": "src/docs/getting-started/OptionsDefaults.story.md", "index": 6, component: Comp6, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-docs-getting-started-optionsdefaults-story-js-a6fe5f9b.js"), true ? [] : void 0, import.meta.url) },
  { "id": "src-docs-getting-started-optionsinterfaces-story-js", "path": ["Options Interfaces"], "filePath": "src/docs/getting-started/OptionsInterfaces.story.js", "story": { "id": "src-docs-getting-started-optionsinterfaces-story-js", "title": "Options Interfaces", "group": "getting-started", "layout": { "type": "single", "iframe": true }, "icon": "carbon:floorplan", "docsOnly": true, "variants": [] }, "supportPluginId": "vanilla", "docsFilePath": "src/docs/getting-started/OptionsInterfaces.story.md", "index": 7, component: Comp7, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-docs-getting-started-optionsinterfaces-story-js-568fa4af.js"), true ? [] : void 0, import.meta.url) },
  { "id": "src-docs-getting-started-templates-story-js", "path": ["Templates"], "filePath": "src/docs/getting-started/Templates.story.js", "story": { "id": "src-docs-getting-started-templates-story-js", "title": "Templates", "group": "getting-started", "layout": { "type": "single", "iframe": true }, "icon": "carbon:template", "docsOnly": true, "variants": [] }, "supportPluginId": "vanilla", "docsFilePath": "src/docs/getting-started/Templates.story.md", "index": 8, component: Comp8, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-docs-getting-started-templates-story-js-ba70b7eb.js"), true ? [] : void 0, import.meta.url) },
  { "id": "src-docs-getting-started-variants-story-js", "path": ["Variants"], "filePath": "src/docs/getting-started/Variants.story.js", "story": { "id": "src-docs-getting-started-variants-story-js", "title": "Variants", "group": "getting-started", "layout": { "type": "single", "iframe": true }, "icon": "carbon:settings-adjust", "docsOnly": true, "variants": [] }, "supportPluginId": "vanilla", "docsFilePath": "src/docs/getting-started/Variants.story.md", "index": 9, component: Comp9, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-docs-getting-started-variants-story-js-c33fecab.js"), true ? [] : void 0, import.meta.url) },
  { "id": "vuetify", "path": ["Vuetify"], "filePath": "/development/plustime/histoire-vuetify-tokens/node_modules/.histoire/plugins/vuetify-design-system/Vuetify.story.vue", "story": { "id": "vuetify", "title": "Vuetify", "group": "demo", "layout": { "type": "single", "iframe": true }, "icon": "mdi:vuetify", "docsOnly": false, "variants": [{ "id": "vuetify-0", "title": "Material Colors", "icon": "mdi:palette" }, { "id": "vuetify-1", "title": "Text And Typography", "icon": "mdi:format-font" }, { "id": "vuetify-2", "title": "Border Radius", "icon": "mdi:border-all" }, { "id": "vuetify-3", "title": "Content", "icon": "mdi:view-grid-plus" }, { "id": "vuetify-4", "title": "Elevation", "icon": "mdi:box-shadow" }, { "id": "vuetify-5", "title": "Display", "icon": "mdi:monitor-screenshot" }, { "id": "vuetify-6", "title": "Float", "icon": "mdi:format-float-left" }, { "id": "vuetify-7", "title": "Overflow", "icon": "mdi:format-text-wrapping-overflow" }, { "id": "vuetify-8", "title": "Sizing", "icon": "mdi:image-size-select-small" }, { "id": "vuetify-9", "title": "Spacing", "icon": "mdi:space-invaders" }] }, "supportPluginId": "vue3", "index": 10, component: Comp10, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_vuetify-46d1d3b7.js"), true ? [] : void 0, import.meta.url) }
];
let tree = [{ "group": true, "id": "top", "title": "", "children": [{ "title": "Introduction", "index": 0 }, { "title": "List of Templates", "index": 1 }] }, { "group": true, "id": "demo", "title": "Demo", "children": [{ "title": "Vuetify", "index": 10 }] }, { "group": true, "id": "getting-started", "title": "Getting Started", "children": [{ "title": "Installation", "index": 5 }, { "title": "Option Defaults", "index": 6 }, { "title": "Options Interfaces", "index": 7 }, { "title": "Templates", "index": 8 }, { "title": "Variants", "index": 9 }] }, { "group": true, "id": "examples", "title": "Example Configs", "children": [{ "title": "Hiding A Variant", "index": 2 }, { "title": "Updating Playground", "index": 3 }, { "title": "Updating Playground Text", "index": 4 }] }];
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-dcb00395.js"), true ? ["./HomeView.vue-dcb00395.js","./vendor-ac1bc468.js"] : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-79259ebf.js"), true ? ["./StoryView.vue-79259ebf.js","./vendor-ac1bc468.js","./MobileOverlay.vue2-d517a303.js","./BaseEmpty.vue-7d95c778.js","./state-7e8f2cd2.js"] : void 0, import.meta.url)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-ac1bc468.js").then((n) => n.au), true ? [] : void 0, import.meta.url),
  "vue3": () => __vitePreload(() => import("./vendor-ac1bc468.js").then((n) => n.av), true ? [] : void 0, import.meta.url)
};
const __default__ = {
  inheritAttrs: false
};
