...
const Comp9 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-ac1bc468.js").then((n) => n.at), true ? [] : void 0, import.meta.url));
let files = [
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-56f34842.js"), true ? ["./HomeView.vue-56f34842.js","./vendor-ac1bc468.js"] : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-bc88239f.js"), true ? ["./StoryView.vue-bc88239f.js","./vendor-ac1bc468.js","./MobileOverlay.vue2-d63ee431.js","./BaseEmpty.vue-ce8e93b0.js","./state-b310b6a4.js"] : void 0, import.meta.url)
    }
  ]
});
