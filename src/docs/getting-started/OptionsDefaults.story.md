...
Below are the default template values used to display each Vuetify variant. The options object you pass into the histoire plugin via the `vuetifyDesignSystem` function can also contain a `templates` attribute, this will be merged into the below object and will override the default value.
                ...
                children: [
                  {
                    ...
                    content:
                      'Use the controls on the right to try out the different spacing helpers.'
                  }
                ]
              }
            ]
